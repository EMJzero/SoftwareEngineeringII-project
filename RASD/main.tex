...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\hsize=0.4\hsize}X|>{\hsize=1\hsize}X|>{\hsize=1.6\hsize}X|}
        ...
        \hline
        G1 & D4 & R1, R2, R3, R4, R5, R6, R7, R23, R25, R27 \\ %List
        \hline
        G2 & D4, D8, D9 & R1, R2, R3, R4, R5, R6, R8, R9, R23, R27 \\ %Cost
        \hline
        G3 & D1, D2, D4 & R1, R2, R3, R4, R5, R6, R7, R10, R11, R12, R13, R22, R23, R25, R27 \\ %Book
        \hline
        G4 & D1, D2, D3, D4, D5, D6, D7, D10, D11 & R1, R2, R3, R4, R5, R6, R14, R15, R16, R17, R18, R19, R20, R21, R24, R26, R27, R28, R29, R30 \\ %Monitor
        \hline
