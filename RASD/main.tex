...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\hsize=0.4\hsize}X|>{\hsize=1\hsize}X|>{\hsize=1.6\hsize}X|}
        ...
        \hline
        G1 & D4 & REDO!!! R1, R2, R7, R23, R25 \\ %List
        \hline
        G2 & D4, D8, D9, D10 & REDO!!! R1, R2, R8, R9, R28, R29, R30, R31, R32, R33, R40 \\ %Cost
        \hline
        G3 & D1, D2, D4 & REDO!!! R1, R2, R7, R10, R11, R12, R13, R21 \\ %Book
        \hline
        G4 & D1, D2, D3, D4, D5, D6, D7, D10 & REDO!!! R1, R2, R14, R15, R16, R17, R18, R19, R20, R24, R26, R27 \\ %Monitor
        \hline
        G5 & D8, D9, D11 & REDO!!! R30, R31, R32, R33, R34, R35 \\ %Energy Source
        \hline
    \end{tabularx}
...
\begin{description}
    ...
    \begin{figure}[!ht]
        \centering
        \includegraphics[page={2}, trim=0cm 2.6cm 0cm 2.6cm, width=\linewidth, clip]{UseCases.pdf}
    ...
    \begin{figure}[!ht]
        \centering
        \includegraphics[page={3}, trim=6.6cm 8.8cm 6.6cm 8.8cm, width=0.6\linewidth, clip]{UseCases.pdf}
        \caption{CPO}
    \end{figure}
\end{description}
