...
\begin{enumerate}
    \item[v1] First draft of the document.
    \item[v1.1] Changed the previous requirement R24 \textit{The eMSP shall be able to pay CPOs for the amount due for recharges performed through them since the last payment} into the domain assumption D14 \textit{The eMSP pays CPOs their share of the amount Users are charged for via methods outside the scope of this document (Ex: direct bank transfer)}.
\end{enumerate}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\centering\hsize=0.3\hsize}X|>{\hsize=1.7\hsize}X|}
        ...
        \hline
        D14 & The eMSP pays CPOs their share of the amount Users are charged for via methods outside the scope of this document (Ex: direct bank transfer) \\
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\centering\hsize=0.1\hsize}X|>{\hsize=1.9\hsize}X|}
        ...
        \hline
        R24 & The CPMS should be able to acquire the location from CSs \\
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\centering\hsize=0.1\hsize}X|>{\hsize=1.9\hsize}X|}
        ...
        \hline
        R41 & The CPMS should report to the user when they sent invalid input data \\
        \hline
        R42 & The CPMS should report to the user when they attempted to perform an unauthorized action \\
        \hline
        R43 & The CPMS should report to the user when the platform encountered an error while processing the action \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\hsize=0.4\hsize}X|>{\hsize=1\hsize}X|>{\hsize=1.6\hsize}X|}
        ...
        \hline
        G1 & D4, D12 & R1, R2, R3, R4, R5, R6, R7, R23, R24, R26 \\ %List
        \hline
        G2 & D4, D8, D9, D12 & R1, R2, R3, R4, R5, R6, R8, R9, R23, R26 \\ %Cost
        \hline
        G3 & D1, D2, D4, D12 & R1, R2, R3, R4, R5, R6, R7, R10, R11, R12, R13, R22, R23, R24, R26 \\ %Book
        \hline
        G4 & D1, D2, D3, D4, D5, D6, D7, D10, D11, D12, D14 & R1, R2, R3, R4, R5, R6, R14, R15, R16, R17, R18, R19, R20, R21, R25, R26, R27, R28, R29 \\ %Monitor
        \hline
        G5 & D1, D4, D8, D9, D11, D13 & R29, R30, R31, R32, R33, R34, R35, R36, R37, R38, R39, R40, R41, R42, R43, R44 \\ %Energy Source
        ...
        %:thumbs_up:
        \hline
        G6 & D1, D4, D10, D13 & R29, R31, R36, R37, R39, R40, R41, R42, R43, R44 \\ %Price
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\hsize=0.8\hsize}X|>{\hsize=1.2\hsize}X|}
        ...
        \hline
        3. User searching and booking a CS & R1, R3, R4, R5, R6, R7, R8, R9, R10, R12, R13, R23, R24, R26 \\
        \hline
        4. User deleting one of his bookings & R1, R3, R4, R5, R6, R11, R14 \\
        \hline
        5. User starting a charging process & R1, R3, R4, R5, R6, R14, R15, R16, R17, R18, R19, R21, R23, R25, R27, R28 \\
        \hline
        6. User interrupting a charging process & R1, R3, R4, R5, R6, R14, R20, R21, R23, R25, R28 \\
        \hline
        7. Charging procedure self terminates and User receives a notification & R1, R3, R4, R5, R18, R19, R23, R25, R28 \\
        \hline
        8. User does not show up for a booked recharge & R22, R25 \\
        \hline
        9. CPO requests information on DSOs’ energy prices and mix of sources & R28, R29, R31, R41, R42, R43 \\
        \hline
        10. CPO assigns energy sources and battery usage policies for a CS & R24, R25, R26, R29, R30, R32, R33, R34, R35, R38, R40, R41, R42, R43, R44 \\
        \hline
        11. CPO assigns nominal-price and user-price to a CS & R24, R25, R26, R29, R36, R37, R38, R40, R41, R42, R43 \\
        \hline
        12. CPO toggles the CPMS operating mode & R38, R41, R42, R43 \\
        \hline
    \end{tabularx}
