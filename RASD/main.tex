...
\begin{description}
    ...
    \item [2. Logged In User] \hfill \\
        A User with a registered account within eMall which has logged in via his credentials, he can still access the CSs list and can also book charge. With his bookings he can then manage his charging sessions one he arrives at the CS.
    \item [3. CPO] \hfill \\
